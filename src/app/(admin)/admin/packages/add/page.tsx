  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="grid gap-4 text-black">
        ...
        <input name="indianPrice" type="number"
          placeholder="Indian Price" className="border p-2"
          onChange={handleChange} />

        <input name="foreignPrice" type="number"
          placeholder="Foreign Price" className="border p-2"
          onChange={handleChange} />

        <input name="maxAdults" type="number"
          placeholder="Max Adults" className="border p-2"
          onChange={handleChange} />

        <input name="maxChildren" type="number"
          placeholder="Max Children" className="border p-2"
          onChange={handleChange} />
        ...
        <div>
          ...
          {preview && (
            <img src={preview} className="w-40 h-40 mt-2 rounded object-cover" />
          )}
        </div>
