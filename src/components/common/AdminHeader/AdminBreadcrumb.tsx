...
export default function AdminBreadcrumb({ heading, items, bgImage }: BreadcrumbProps) {
  return (
    <div className="relative w-full h-64 md:h-80 flex items-center">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 w-full">
        ...
        <nav className="text-md text-white flex items-center justify-center mt-3 space-x-1 mb-3 font-dm text-shadow-md">
          <Link href="/admin/" className="hover:text-lg font-semibold text-white">Admin</Link>
